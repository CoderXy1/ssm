    ...
    k(f, "mixins/navigation.js", [], function () {
        return {
            initUpdate: function (g) {
                ...
                e.navigation.updates.push({update: g, context: e})
            }
        }
    });
    k(f, "modules/exporting.src.js", [f["parts/Globals.js"], f["parts/Utilities.js"], f["mixins/navigation.js"]], function (g, e, f) {
        var k = e.discardElement, t = e.extend, I = e.isObject, C = e.objectEach, r = e.pick;
        e = g.defaultOptions;
        var w = g.doc, A = g.Chart, x = g.addEvent, J = g.removeEvent, B = g.fireEvent, v = g.createElement, n = g.css,
            p = g.merge, K = g.isTouchDevice, y = g.win, F = y.navigator.userAgent, D = g.SVGRenderer,
        ...
        g.post = function (a, b, c) {
            ...
            C(b, function (b, a) {
                v("input", {type: "hidden", name: a, value: b}, null, d)
            });
            d.submit();
            k(d)
        };
        t(A.prototype, {
            sanitizeSVG: function (a,
                ...
                t(c.chart, {animation: !1, renderTo: d, forExport: !0, renderer: "SVGRenderer", width: e, height: q});
                ...
                var a =
                    this.userOptions.title && this.userOptions.title.text, b = this.options.exporting.filename;
                if (b) return b;
                ...
                var b = this, c = [], d = w.body, e = d.childNodes, g = b.options.exporting.printMaxWidth, f;
                if (!b.isPrinting) {
                    b.isPrinting = !0;
                ...
                var h = this, q = h.options.navigation, p = h.chartWidth, z = h.chartHeight, m = "cache-" + a, l = h[m],
                    u = Math.max(e, f);
                if (!l) {
                    ...
                    var k = v("div", {className: "highcharts-menu"}, null, l);
                    h.styledMode || n(k, t({
                ...
                var b =
                        this, c = b.renderer, d = p(b.options.navigation.buttonOptions, a), e = d.onclick, g = d.menuItems,
                    f = d.symbolSize || 12;
                ...
                if (!1 !== d.enabled) {
                    ...
                    var m = c.button(d.text, 0, 0, z, h, n, k).addClass(a.className).attr({title: r(b.options.lang[d._titleKey || d.titleKey], "")});
                    m.menuClassName = a.menuClassName || "highcharts-menu-" + b.btnCount++;
                    if (d.symbol) {
                        var l = c.symbol(d.symbol, d.symbolX - f / 2, d.symbolY - f / 2,
                            f, f, {width: f, height: f}).addClass("highcharts-button-symbol").attr({zIndex: 1}).add(m);
                        b.styledMode || l.attr({
        ...
        A.prototype.renderExporting = function () {
            var a = this, b = a.options.exporting, c = null, d = a.isDirtyExporting ||
                !a.exportSVGElements;
            a.buttonOffset = 0;
            a.isDirtyExporting && a.destroyExport();
            d && (a.exportEvents = [], a.exportingGroup = a.exportingGroup || a.renderer.g("exporting-group").attr({zIndex: 3}).add(), C(c, function (b) {
                a.addButton(b)
