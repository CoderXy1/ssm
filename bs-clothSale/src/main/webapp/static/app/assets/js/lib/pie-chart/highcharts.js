...
(function (P, M) {
                ...
                c.fireEvent(this.renderer,
                    "complexColor", {args: arguments}, function () {
                        ...
                        e && (w = a[e], k = D.gradients, g = a.stops, p = d.radialReference, v(w) && (a[e] = w = {
                            ...
                            0 === a[1].toString().indexOf("rgba") ? (m = c.color(a[1]), r = m.get("rgb"), x = m.get("a")) : (r = a[1], x = 1);
    ...
    M(I, "parts/Options.js", [I["parts/Globals.js"]], function (c) {
        ...
        c.defaultOptions = {
            colors: "#03a9f4 #f76b8a #fa4659 #8971d0 #5873fe #ffb400 #e4d354 #2b908f #f45b5b #91e8e1".split(" "),
